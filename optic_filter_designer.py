...
class OptimizedTMM_Calculator:
    """Optimized Transfer Matrix Method calculator for large optical stacks"""
...
class TMM_Plots(QWidget):
    ...
    def plot_results(self, wavelengths, R_TE, R_TM):
        ...
        self.ax.plot(wavelengths, R_dB, 'r-', linewidth=2, label='TM')
    ...
    def calculate_tmm(self):
        ...
        class TMM_Worker(QThread):
            ...
            def run(self):
                try:
                    # Create calculator
                    calculator = OptimizedTMM_Calculator()
